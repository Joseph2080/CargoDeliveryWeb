...
<header>
    <div class="fixed-header">
        <div class="container">
            <nav>
                <a href="<%=request.getContextPath()%>/admin" methods="get" class = "nava" >Admin</a>
                 <a href="<%=request.getContextPath()%>/logout" methods="get" class = "nava" >Log out</a>
            </nav>
        </div>
    </div>
</header>
...
<div class="row">
    ...
    <div class="container">
        ...
        <h3 class="h3">Cargos that require Approval</h3>
        </br>
        </br>
        ...
        <form action="<%= request.getContextPath() %>/admin" method="get">
            <table class="table table-bordered" >
                ...
                <c:forEach var="cargo" items="${listCargoAdmin}">
                    <tr>
                        ...
                        <td><c:out value="${cargo.isDelivered()}" /></td>
                        <td><a href="<%= request.getContextPath() %>/approveCargo?id=<c:out value='${cargo.getCargoId()}' />" methods="get">Approve Delivery</a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
